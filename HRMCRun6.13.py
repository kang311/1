...
parser.add_argument('--hrmc_steps', type=int, default=1000, help='每个周期的HRMC步数')
...
parser.add_argument('--cycles', type=int, default=100, help='MD-HRMC循环周期数')
...
def main():
    ...
    if hasattr(ENGINE, 'energy_constraint') and ENGINE.energy_constraint:
        energy_error = ENGINE.energy_constraint.data
