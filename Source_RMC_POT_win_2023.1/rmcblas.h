///////////////////////////////////////////////////////////////////
// Modified by Mikael Leetmaa, leetmaa@physto.se 21-11-2006
// MOdified by Orsolya Gereben, ogereben@freemail.hu 30-01-2007
// 
// This is the 'cblas.h' header from ATLAS version 3.6.0
//   http://math-atlas.sourceforge.net/faq.html#doc
// 
// The only change made is that 'void cblas_dgemv'
// is now declared as 'extern "C" void cblas_dgemv' (MK)
// and 'void cblas_dgemm' is now 'extern "C" void cblas_dgemm' (OG)
// for the purpouse to facilitate linking with the
// RMC++ code using the gnu C++ compiler (g++)
////////////////////////////////////////////////////////////////////
