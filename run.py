...
from fullrmc.BondRatioHRMCEngine import BondRatioHRMCEngine
...
HRMC_STEPS = 10000  # HRMC模拟步数
HRMC_INITIAL_TEMPERATURE = 800  # K，HRMC模拟初始温度
HRMC_FINAL_TEMPERATURE = 300  # K，HRMC模拟最终温度
COOLING_RATE = 0.98  # 温度冷却率 

# 约束权重
PDF_WEIGHT = 1 # PDF约束权重
BOND_RATIO_WEIGHT = 1 # 键比例约束权重
